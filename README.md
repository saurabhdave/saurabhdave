...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=20&pause=1200&color=F05138&center=true&vCenter=true&width=620&lines=11%2B+years+crafting+iOS+experiences+%F0%9F%93%B1;Building+AI-powered+SwiftUI+SDKs+%F0%9F%A4%96;OpenAI+%26+Anthropic+Streaming+on+iOS;Ship+clean+Swift.+Embrace+AI.+Keep+learning.)](https://git.io/typing-svg)
...
struct SaurabhDave {
    ...
    let currentlyBuilding = "AIChatSupport SDK"
    let exploring = ["AI Agents", "On-device ML", "LLM Streaming"]
